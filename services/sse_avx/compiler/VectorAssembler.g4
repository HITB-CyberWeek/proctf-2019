...
v_load: V_LOAD op0=(VREGISTER|VREGISTER_RANGE) ',' op1=(VREGISTER|DECIMAL|HEXADECIMAL) ',' op2=SREGISTER64
    ;

v_store: V_STORE op0=(VREGISTER|VREGISTER_RANGE) ',' op1=(VREGISTER|DECIMAL|HEXADECIMAL) ',' op2=SREGISTER64
    ;
